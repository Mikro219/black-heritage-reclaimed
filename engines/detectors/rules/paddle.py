"""
paddle — both wrists arc together on the same side of the body midline, ≥N strokes.
...
Params:
  ...
  waist_y_offset (float): shifts the hip threshold up (negative) or down
                          (positive) in normalised screen coords. Default 0.0.
